---
title: Shadcn AI Guide
description: A comprehensive guide for managing Shadcn AI components and registry
---

# Shadcn AI Guide

This guide explains the workflow for adding and managing components in the Shadcn AI registry system.

## Quick Start

To add a new component to Shadcn AI, follow these steps:
